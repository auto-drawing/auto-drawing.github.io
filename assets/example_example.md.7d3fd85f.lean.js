 ...
 * copyright: xiaofei
 * license: MIT
 */var eh=(r=>(r[r.left=0]="left",r[r.middle=1]="middle",r[r.right=2]="right",r))(eh||{});function td(r,t,e){const{scaleMin:n=.5,scaleMax:i=100}=e||{};r.on("mousewheel",a=>{a.event.preventDefault();const{scaleX:o,scaleY:s}=t,l=1+a.wheelDelta/5;if(l<n||l>i)return;const{x:h=0,y:f}=t,u=(e==null?void 0:e.scaleCenter)||"canvasCenter",c={scaleX:o*l,scaleY:s*l},p={scaleX:o*l,scaleY:s*l,x:a.offsetX-(a.offsetX-h)*l,y:a.offsetY-(a.offsetY-f)*l},d=u==="canvasCenter"?c:p;t.animateTo(d,{duration:100,delay:0,done:()=>{e!=null&&e.callback&&e.callback({scale:t.scaleX,x:t.x,y:t.y})}})})}const rd=r=>{var t;const e=((t=r.dom)==null?void 0:t.getElementsByTagName("canvas"))||[];Array.from(e).forEach(i=>{i.oncontextmenu=a=>{a.preventDefault(),a.stopPropagation()}})};function ed(r,t,e){const n={startX:0,startY:0,canTranslate:!1},{mouse:i="left"}=e||{};r.on("mousedown",o=>{const{clientX:s,clientY:l}=o.event;n.startX=s,n.startY=l,n.canTranslate=o.event.button===eh[i],i==="right"&&rd(r)});function a(o){if(!n.canTranslate)return;const{clientX:s,clientY:l}=o.event,h=s-n.startX,f=l-n.startY,u=t.x+h,c=t.y+f;t.animateTo({x:u,y:c},{duration:100,delay:0,done:()=>{e!=null&&e.callback&&e.callback({scale:t.scaleX,x:t.x,y:t.y})}})}r.on("mouseup",o=>{a(o),n.canTranslate=!1})}/*!
 * name: auto-drawing
 * version: v1.2.1
 * description: auto-drawing based zrender
 * author: xiaofei
